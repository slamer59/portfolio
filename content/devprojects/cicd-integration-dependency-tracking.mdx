...
2. [Set thresholds based on your codebase](./04-analyze-large-codebases.md)
3. Run analysis locally first: `code-explorer analyze ./src`
4. [Find and fix](./05-find-circular-dependencies.md) existing issues before enabling gates
