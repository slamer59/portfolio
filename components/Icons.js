...
export const CircularText = ({ className, ...rest }) => (
  ...
  <text font-size="30" letter-spacing="2" font-family="sans-serif" font-weight="normal">
        <textPath side="left" startOffset="5">Photographe - Développeur - Energétique</textPath></text>
        </path> */}
  </svg>
);
