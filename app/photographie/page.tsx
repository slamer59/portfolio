      ...
      <Layout className="flex flex-col items-center justify-center w-full mb-16 dark:text-light">
        ...
        >
          <h2 className="mb-4 text-xl text-center dark:text-light">
            C'est souvent dit que l'<span className="font-bold text-primary dark:text-light">imagination</span> est plus importante que la <span className="font-bold text-primary dark:text-light">connaissance</span>.
            ...
            Bien que la connaissance soit essentielle pour comprendre le monde qui nous entoure, c'est l'imagination qui nous pousse à aller au-delà des limites actuelles et à envisager des possibilités nouvelles et inexplorées. L'<span className="font-bold text-primary dark:text-light">imagination</span> nourrit la pensée créative et la capacité à voir les choses sous un angle différent, ce qui peut conduire à des <span className="font-bold text-primary dark:text-light">découvertes</span> et des réalisations importantes.
          </h2>
          <div className="mb-4 text-xl text-center dark:text-light">
            ...
            Dans ces images, l'essence de <span className="font-bold text-primary dark:text-light">mes univers</span>, que j'espère riches en émotions et en créativité.
            Chaque cliché tente de révéler des <span className="font-bold text-primary dark:text-light">mondes variés</span> ancrés dans l'art, tels que la musique, la danse, le théâtre, la peinture, la sculpture, et l'architecture, trés souvent portés et incarnés par mes <span className="font-bold text-primary dark:text-light">ami.e.s artistes</span>.
          </div>
        </AnimatedText>
        <PhotoProjectLayout />
      </Layout>
