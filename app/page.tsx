...
export const metadata = {
	title:
		"Thomas Pedot photographe, docteur en énergie et développeur. Immortaliser L'instant Présent, Savourer Chaque Moment. | Accueil",
	description:
		"Photographe et développeur web, je m'efforce de marier l'art et la technologie pour donner vie à des projets uniques et inspirants.",
...
export default function Home() {
	...
	return (
		<>
			<TransitionEffect />
			<div
				className="fixed inset-y-0 right-0 items-end inline-block object-right w-1/2 col-span-1 bg-center bg-cover sm:hidden md:hidden"
				style={{
			...
			<section className="z-10 pt-6 pb-6 bg-transparent top-10 dark:text-light">
				<div className="grid items-center content-center grid-cols-2 mx-auto sm:grid-cols-1">
					<div className="flex flex-col items-center justify-center w-full py-2 mx-auto overflow-hidden text-left sm:py-0">
						<h1 className="inline-block px-6 py-16 font-extrabold dark:text-light text-dark w-full text-4xl sm:text-5xl md:text-6xl lg:text-4xl xl:text-6xl 2xl:text-6xl">
							Immortaliser l'instant présent, savourer chaque moment.
						</h1>
						<div className="w-full px-6 rounded-md">
							<p className="mt-4 mb-2 text-xl dark:text-light">
								Toujours en quête de nouvelles perspectives à travers l'
								<span className="font-bold text-primary dark:text-light">
									objectif
								</span>{" "}
								de mon appareil photo ou les lignes de code, je m'efforce de
								marier l'art et la technologie pour donner vie à des{" "}
								<span className="font-bold text-primary dark:text-light">
									projets uniques et inspirants
								</span>
								.
							</p>
						</div>
			...
			<section className="z-10 border-t-2 border-black dark:border-primaryDark relative flex flex-row w-full bg-transparent mx-auto md:grid-cols-1 h-[900px] md:flex-col">
				...
				<div className="flex flex-col items-center content-center justify-center w-full bg-light dark:bg-dark dark:text-light">
					...
					<div className="p-2 m-2 text-xl">
						<p>
							J'ai découvert la photographie en 2011 grâce à mon frère qui m'a
							donné son appareil photo reflex Canon 350D.
						</p>
						<br />
						<p>
							Pour mon voyage au{" "}
							...
							, j'ai pu utiliser sans crainte cette appareil dans un des pays
							les plus beaux que j'ai pu visiter. C'est au retour de ce voyage
							que j'ai pris conscience de l'importance de capturer des moments
							de vie, des paysages, des{" "}
							<span className="font-bold text-primary dark:text-light">
								émotions
							</span>
							.
			...
			<section className="relative z-20 flex flex-col items-center justify-center object-center w-full mx-auto border-t-2 dark:border-primaryDark border-black bg-light dark:bg-dark h-[1000px] md:flex-col dark:text-light">
				<div
					className="flex h-[1000px] items-center content-center w-screen flex-col-1 bg-light dark:bg-dark
				...
				<div className="flex flex-col items-center object-center text-center">
					...
					<div className="p-4 text-2xl text-center dark:text-light">
						<p>
							Des ami.e.s musicien.ne.s m'ont donné l'opportunité de les
							photographier lors de{" "}
							<span className="font-bold text-primary dark:text-light">
								concerts
							</span>
							, de répétitions, de tournages de clips.
						</p>
						<br />
						<p>
							C'est avec le temps que mes premières opportunités s'offrent à
							moi.
						</p>
						<br />
					</div>
			...
			<section className="relative z-20 flex flex-col w-full mx-auto bg-light dark:bg-dark dark:text-light">
				<div className="flex flex-col items-center object-center text-center">
					...
					<div className="p-4 text-2xl text-center dark:text-light">
						<p>Vous souhaitez échanger avec moi pour un projet ?</p>
						<br />
						<p>
							Ouvert à la discussion, je serais très heureux d'échanger avec
							vous de vos projets.
						</p>
						<br />
						<p className="font-bold text-primary dark:text-light">
